...
const EditProfile = ({ profile: { profile, loading }, createProfile, getCurrentProfile, history }) => {
    ...
    }, [getCurrentProfile, loading]);// will run only once, when loading is finished
    ...
    // set the state according to the input data, build as object of key/value pairs
    // grabs name attribute as key and takes value of event as value
